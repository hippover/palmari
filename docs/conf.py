# -*- coding: utf-8 -*-
#
# palmari documentation build configuration file, created by
...
project = u'palmari'
copyright = u'2015, Hippolyte Verdier'
author = u'Hippolyte Verdier'
...
man_pages = [
    (main_doc, 'napari-cookiecutterplugin_name', u'palmari Documentation',
     [author], 1)
]
